...
vendors![
    ...
    },
    {
        name: "yay",
        confirm: "--noconfirm",
        install: "yay --topdown --cleanafter -S $",
        remove: "pacman -R -s $",
        upgrade: "yay --topdown --cleanafter -S $",
        search: "yay --topdown -S -s $",
        info: "yay --topdown -S -i $",
        update_index: "yay --topdown -S -y",
        upgrade_all: "yay --topdown -S -y -u",
        list_installed: "pacman -Q",
    },
    {
        name: "pkg",
